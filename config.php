...
$start_day = "08.02.2021"; # Первый день семестра, День должен быть понедельником!
$delta = 5; # Поправка на количество недель, для того, чтобы первая неделя семестра была первой.
