...
$start_day = "31.08.2020"; # Первый день семестра, День должен быть понедельником!
...
$first_course_year = 2020; # Год поступления первого курса в текущем учебном году.
...
$notification = json_encode(array(
    "is_show" => true,
    "key" => "30_08_update",
    "header" => "Добавлено расписание осеннего семестра",
    "message" => "Здравствуйте, уважаемые студенты! <br><br>
                    Добавлено расписание осеннего семестра 2020/2021 уч. года<br>
                    Обращаю Ваше внимание, что первые 2-3 недели после начала семестра возможны накладки и корректировки расписания. <br>
                    Постараюсь обновлять расписание своевременно, если кто-то готов помочь в сопровождении проекта/обновлении расписания, <br>
                    пишите на почту (<a href='mailto:ya.slavar@yandex.ru'>ya.slavar@yandex.ru</a>), буду рад любой помощи.<br>
