...
$notification = json_encode(array(
    ...
    "message" => "Здравствуйте, уважаемые студенты! <br><br>
                  ДИСКЛЕЙМЕР : Сайт не является официальным сайтом РТУ МИРЭА, при использовании расписания с этого сайта будьте внимательны! <br>
                  Желаю всем  успехов в учёбе :)<br>
                  --<br>
